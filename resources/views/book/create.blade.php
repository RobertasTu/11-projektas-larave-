                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('book.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="book_isbn" type="text" class="form-control @error('book_isbn') is-invalid @enderror" name="book_isbn" value='{{ old('book_isbn')}}'required autocomplete="book_isbn" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="book_pages" type="text" class="form-control @error('book_pages') is-invalid @enderror" name="book_pages" value='{{ old('book_pages')}}' required autocomplete="book_pages" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                               ...
                               <textarea class='summernote' name='book_about' value='{{ old('book_about') }}' required>
                                   {{-- <p>{!! $book->about !!}</p> --}}
                               </textarea>
                            </div>
                        </div>
